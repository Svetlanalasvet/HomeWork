...
#  1: EDIT and ADD code BELOW to do the following that's stated in the
#       comments below that start with " 1" for the get_input_args function
...
def get_input_args():
    ...
    #  1a. EDIT parse.add_argument statements BELOW to add type & help for:
    ...
    #  1b. Replace None with parser.parse_args() parsed argument
