...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        #  5a. REPLACE pass with CODE that counts how many pet images of
        ...
        #  5b. REPLACE pass with CODE that counts how many pet images
    ...
    #  5c. REPLACE zero(0.0) with CODE that calculates the % of correctly
    ...
    #  5d. REPLACE zero(0.0) with CODE that calculates the % of correctly
    ...
    #  5e. REPLACE zero(0.0) with CODE that calculates the % of correctly
    ...
    # REPLACE None with the results_stats_dic dictionary that you
