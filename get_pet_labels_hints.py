...
#  2: EDIT and ADD code BELOW to do the following that's stated in the
#       comments below that start with " 2" for the get_pet_labels function
...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           # : 2a. BELOW REPLACE pass with CODE that will process each
    ...
    #  2b. Replace None with the results_dic dictionary that you created
    # with this function
    return None
